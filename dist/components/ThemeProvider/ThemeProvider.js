...
var _default = function _default(props) {
  ...
  var getColGridColumns = function getColGridColumns() {
    if (styledBootstrapGridTheme.col && (0, _utils.isNumber)(styledBootstrapGridTheme.col.gridColumns)) {
  ...
  var styledBootstrapGridTheme = {
    ...
    getColGridColumns: getColGridColumns
  };
